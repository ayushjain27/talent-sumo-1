...
const Search = () => {
  return (
   ...
   <div className={`${styles.cardSection} card bg-dark text-white h-50`}>
        ...
        <div className={`${styles.search} mb-2 mt-3`}><i className="fa fa-search" aria-hidden="true"></i>Search</div>
    </div>
    ...
    <div className={`${styles.container} container mt-3 mb-5 rounded p-3`}>
      ...
      <div className={`${styles.heading} border border-primary text-blue p-2`}>Q&A</div>
      <div className={`${styles.heading} border border-primary text-blue p-2`}>AD</div>
      <div className={`${styles.heading} border border-primary text-blue p-2`}>N&M</div>
      </div>
      <div className="d-flex">
      <div className={`${styles.heading} border border-primary p-2`}>TCS</div>
      <div className={`${styles.heading} border border-primary p-2`}>5678</div>
