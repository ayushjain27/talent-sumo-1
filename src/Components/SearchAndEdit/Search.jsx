...
const Search = () => {
  return (
    <>
      <div style={{ display: 'flex', justifyContent: 'center', textAlign: 'center' }} className="mt-4">
        <h3>INTERACTION SEARCH</h3>
      </div>
      <div className={`${styles.cardSection} card bg-dark text-white`}>
        <div className="card-body">
          <div className={`${styles.name} my-3`}>Access Code <input className={`${styles.input} p-1 rounded w-50`} type="number" /></div>
          <div className={`${styles.or} `}>OR</div>
          <div className={`${styles.name} my-3`}> Company <input className={`${styles.input} p-1 rounded w-50`} type="text" /></div>
          <div className={`${styles.search} mb-2 mt-3`}>Search<input className="rounded ms-2" type="text" /></div>
        </div>
      </div>
